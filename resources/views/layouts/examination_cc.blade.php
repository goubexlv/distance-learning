    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                <li class="menu-item ">
                    <a href="{{route('class.add_examination_cc', ['ue'=>$ue->code])}}" class="menu-link">
                ...
                <br>
                <li class="menu-item ">
                    <a href="{{route('questions.index_cc', ['ue'=>$ue->code])}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-user"></i> Questions
                    </a>
                </li>
                <br>
                <li class="menu-item ">
                    <a href="{{route('options.index_cc', ['ue'=>$ue->code])}}" class="menu-link">
                ...
                <br>
                <li class="menu-item">
                    <a href="{{route('result.index_cc', ['ue'=>$ue->code])}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-user"></i> Results
                    </a>
                </li>
            </ul>
