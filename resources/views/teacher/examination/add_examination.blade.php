...
@section("container-xxl")
    ...
    <div class="container-fluid">
            ...
            <form id="addChapter" method="POST" action="{{route('exam.add', $ue->code)}}" enctype="multipart/form-data">
                <hr>
                @csrf
                <div class="card-header bg-white shadow-sm border-0">
                    <h6 class="d-block position-relative text-dark py-2">Add examination to this Course fot SN</h6>
                </div>
