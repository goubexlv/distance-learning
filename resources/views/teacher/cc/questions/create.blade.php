        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{ route('questions.index_cc', ['ue'=>$ue->code]) }}" class="btn btn-primary btn-sm shadow-sm">{{ __('Go Back') }}</a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('questions.new_cc') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="category">{{ __('Code Ue') }}</label>
